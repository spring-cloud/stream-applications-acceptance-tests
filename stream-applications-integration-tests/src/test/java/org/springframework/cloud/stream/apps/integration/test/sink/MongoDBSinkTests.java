...
public class MongoDBSinkTests extends KafkaStreamIntegrationTestSupport {
	...
	//
	// @Container
	// private static MongoDBContainer mongoDBContainer = new
	...
	//
	// @Container
	// private StreamApps streamApps = kafkaStreamApps(MongoDBSinkTests.class.getSimpleName(),
	// kafka)
	...
	// @Test
	// void postData() {
	// String json = "{\"name\":\"My Name\",\"address\":{ \"city\": \"Big City\", \"street\":
	// \"Narrow Alley\"}}";
	...
	// assertThat(docs).allMatch(document -> document.get("name", String.class).equals("My
	// Name"));
	// }
}
