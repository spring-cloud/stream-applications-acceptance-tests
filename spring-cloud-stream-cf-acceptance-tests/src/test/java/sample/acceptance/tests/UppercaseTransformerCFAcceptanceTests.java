 ...
 * @author Soby Chacko
 */
public class UppercaseTransformerCFAcceptanceTests extends AbstractCFAcceptanceTests {

	private static final Logger logger = LoggerFactory.getLogger(UppercaseTransformerCFAcceptanceTests.class);
